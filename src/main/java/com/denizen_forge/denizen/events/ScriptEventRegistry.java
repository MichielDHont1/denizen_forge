...
public class ScriptEventRegistry {
    ...
    public static void registerMainEvents() {
        ...
        ScriptEvent.registerScriptEvent(new ExplosionScriptEvent());
        ...
        ScriptEvent.registerScriptEvent(new PotionBrewEventScriptEvent());
        ...
        ScriptEvent.registerScriptEvent(new PistonScriptEvent());
        ...
        ScriptEvent.registerScriptEvent(new BabyEntitySpawnScriptEvent());
        ScriptEvent.registerScriptEvent(new FarmlandTrampleScriptEvent());
        ScriptEvent.registerScriptEvent(new EntityCombustsScriptEvent());
        ScriptEvent.registerScriptEvent(new PortalSpawnScriptEvent());
