    ...
    public static void registerTags() {
        ...
        registerTag("contains_item", (attribute, object) -> {
            ...
            for (ItemStack item : object.getContents()) {
                if (item != null) {
                    if (ForgeScriptEvent.tryItem(new ItemTag(item), matcher)) {
        ...
        registerTag("quantity_item", (attribute, object) -> {
            ...
            for (ItemStack item : object.getContents()) {
                if (item != null) {
                    if (matcher == null || ForgeScriptEvent.tryItem(new ItemTag(item), matcher)) {
                        found_items += item.getAmount();
                    }
                }
            }
        ...
        registerTag("advanced_matches", (attribute, object) -> {
            ...
            return new ElementTag(ForgeScriptEvent.tryInventory(object, attribute.getContext(1)));
        });
    }
