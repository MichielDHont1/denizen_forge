            ...
            for (int x = 0; x != x_distance + 1; x++) {
                for (int y = 0; y != y_distance + 1; y++) {
                    for (int z = 0; z != z_distance + 1; z++) {
                        ...
                        if (ForgeScriptEvent.tryMaterial(loc.getBlockTypeForTag(attribute), matcher)) {
                            list.add(loc);
                        }
                        index++;
                        if (index > max) {
                ...
                for (int y = 0; y != y_distance + 1; y++) {
                    for (int z = 0; z != z_distance + 1; z++) {
                        ...
                        if (loc.getBlockTypeForTag(attribute).isAir()
                                ...
                                : ForgeScriptEvent.tryMaterial(loc.clone().add(0, -1, 0).getBlockTypeForTag(attribute), matcher)))) {
